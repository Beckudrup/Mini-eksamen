...
class Database {
  ...
  void saveExercise(String question, String answer1, String answer2, String answer3, String answer4) {
    ...
    /*if ( i>0 /*Next key for a new screen for exercises i pressed*) {
     db.query("UPDATE Exercises SET question = '"+ question + "' , answer1 = '"+ answer1 + "', answer2 = '"+ answer2 + "', answer3 = '"+ answer3 + "', answer4 = '"+ answer4 + "');"); // I is a golbal int that increases by one every time next is pressed
     }*/
